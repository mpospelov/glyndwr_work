<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="Crusaders.Admin.Account.RegisterExternalLogin" %>
