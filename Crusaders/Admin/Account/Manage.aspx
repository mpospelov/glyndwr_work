<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Crusaders.Admin.Account.Manage" %>

<%@ Register Src="~/Admin/Account/OpenAuthProviders.ascx" TagPrefix="uc" TagName="OpenAuthProviders" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <form runat="server">
        ...
        <section id="externalLoginsForm">
            ...
            <uc:OpenAuthProviders runat="server" ReturnUrl="~/Admin/Account/Manage.aspx" />
        </section>
    </form>
</asp:Content>
